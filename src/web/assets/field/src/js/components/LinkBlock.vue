    ...
    methods: {
        getParsedLinkTypeHtml(html) {
            if (typeof html === 'string') {
                ...
                return html.replace(new RegExp(`HyperBlock_${this.settings.placeholderKey}`, 'g'), this.blockIndex);
            }
        ...
        cacheHtml() {
            ...
            if (this.$refs.fields) {
                ...
                const idPlaceholder = `${this.settings.namespacedId}-HyperBlock_${this.settings.placeholderKey}`;
                const namePlaceholder = `${this.settings.namespacedName}[HyperBlock_${this.settings.placeholderKey}]`;
